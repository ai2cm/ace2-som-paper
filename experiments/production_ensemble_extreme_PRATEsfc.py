...
INFERENCE_ENSEMBLE_OVERLAY_TEMPLATE_PRECIP = {
    "n_forward_steps": 14600,
    "logging": {
        "log_to_screen": True,
        "log_to_wandb": True,
...
EVALUATOR_ENSEMBLE_OVERLAY_TEMPLATE_PRECIP = {
    "n_forward_steps": 14600,
    "logging": {
        "log_to_screen": True,
        "log_to_wandb": True,
        ...
        if args.experiments:
            for (
                ...
                rollout = InferenceRollout(
                    ...
                    tag="ensemble-member-extreme-PRATEsfc",
                    overlay_template=INFERENCE_ENSEMBLE_OVERLAY_TEMPLATE_PRECIP,
        ...
        for (
            ...
            for climate, root in REFERENCE_DATASETS.items():
                ...
                experiment = EvaluatorRollout(
                    ...
                    tag="extreme-PRATEsfc",
                    overlay_template=EVALUATOR_ENSEMBLE_OVERLAY_TEMPLATE_PRECIP,
                    wandb_run_group=WANDB_RUN_GROUP,
                    priority="high"
                )
                experiment.submit()
